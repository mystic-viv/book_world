...
class LibrarianLogin extends StatefulWidget {
  const LibrarianLogin({Key? key}) : super(key: key);

  @override
  State<LibrarianLogin> createState() => _LibrarianLoginState();
}
                                    ...
                                    if (_formKey.currentState!.validate()) {
                                      try {
                                        ...
                                        if (AuthService.isLibrarian()) {
                                          ...
                                          // Not a librarian, show error and log out
                                          await AuthService.logout();
                                          showSnackBar(
                                            "Error",
                                            "You don't have librarian privileges",
                                          );
                                        }
                                      } catch (e) {
                                        showSnackBar(
                                          "Error",
                                          "Invalid credentials or you don't have librarian privileges",
                                        );
                                      }
                                    }
                                  },
